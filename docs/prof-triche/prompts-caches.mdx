...
Une méthode efficace que j'utilise consiste à **cacher des prompts dans les sujets** que je distribue aux étudiants. Cette approche, également utilisée par des solutions professionnelles comme [CERTYX pour la détection de triche IA dans les PDFs](https://certyx.fr/articles/prompts-caches-dans-les-pdfs-detecter-la-triche-ia-avec-certyx), consiste à insérer des prompts de manière invisible ou presque invisible dans le document :
...
## Solutions professionnelles et ressources complémentaires

Si vous souhaitez approfondir cette méthode ou découvrir des solutions professionnelles automatisées, vous pouvez consulter l'article de [CERTYX sur les prompts cachés dans les PDFs pour détecter la triche IA](https://certyx.fr/articles/prompts-caches-dans-les-pdfs-detecter-la-triche-ia-avec-certyx), qui présente une approche similaire avec des outils automatisés pour l'intégration de prompts cachés dans les documents d'examen.
...
<Backlink documentPath="/docs/prof-triche/prompts-caches" />
